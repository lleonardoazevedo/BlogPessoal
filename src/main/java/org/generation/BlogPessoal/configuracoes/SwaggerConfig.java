package org.generation.BlogPessoal.configuracoes;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/lleonardoazevedo/BlogPessoal").contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Leonardo Azevedo", "https://github.com/lleonardoazevedo", "lleonardo.azevedo@gmail.com");
	}
